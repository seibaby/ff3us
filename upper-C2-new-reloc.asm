hirom
incsrc tracelog-plus-disasm-reloc.asm
org $C26800
...
C2686E:  db $FF : db $4C,$0C,$50,$4C,$F3,$57,$4C,$C4 ; Control byte, then 8-byte data block
...
C2AA34:  LDA #$08       ; 8
C2AA36:  JSR C2A961     ; Call C1/022A 8 times
C2AA39:  LDA #$17       ; 23
C2AA3B:  STA $898D
C2AA3E:  JSL C10226
C2AA42:  JSR C2A942
...
C2AAE3:  LDA #$80       ; -128
C2AAE5:  JSR C2A961     ; Call C1/022A 128 times
C2AAE8:  LDA $E9F9      ; Screen brightness
C2AAEB:  BEQ C2AAF7     ; If 0, return
C2AAED:  LDA #$10       ; 16
C2AAEF:  JSR C2A961     ; Call C1/022A 16 times
...
C2B94C:  JSR C2B8F3     ; Divide 16-bit Variable $2C by 16-bit $2E.  Put
...
C2B958:  JSR C2B8F3     ; Divide 16-bit Variable $2C by 16-bit $2E.  Put
                        ; Quotient in 16-bit $30, and Remainder in 16-bit $32.
C2B95B:  TDC
...
C2BC0A:  AND #$07
C2BC0C:  BNE C2BC37
C2BC0E:  JSR C2BBE6     ; Random number generator
C2BC11:  AND #$07
C2BC13:  TAX
C2BC14:  LDA C2BBF2,X
C2BC18:  REP #$20
...
C2EED3:  STA $896F
C2EED6:  LDA #$02
C2EED8:  JSR C2EEFE     ; Why not JSR C2EEFC?
C2EEDB:  JMP C2FA33
...
C2F0E5:  JSL C12452
C2F0E9:  JSR C2FA70
C2F0EC:  JSR C2FA4F     ; Well, this part doesn't seem familiar at all...
C2F0EF:  LDA #$CC
C2F0F1:  STA $002124
...
;C2FAA4:  fillbyte $ff : fill 457
C2FAA4:  padbyte $ff : pad $C2FC6D
